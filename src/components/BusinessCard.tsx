    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
      ...
      <div className="p-5 flex-1">
        ...
        {business.area && (
          <p className="text-sm text-hustle-muted mb-2 flex items-center gap-1">
            <svg className="w-4 h-4 flex-shrink-0" width="16" height="16" style={{width:"16px",height:"16px",maxWidth:"16px",maxHeight:"16px",flexShrink:0}} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <Link href={`/${(business.area as any)?.city?.slug || "lagos"}/${business.area.slug}`} className="hover:text-hustle-blue transition-colors">
              {business.area.name}{(business.area as any)?.city?.name ? `, ${(business.area as any).city.name}` : ''}
            </Link>
          </p>
        )}
      ...
      <div className="border-t border-gray-100 px-5 py-3 flex items-center gap-2">
        {business.whatsapp && (
          ...
          >
            <svg className="w-4 h-4" width="16" height="16" style={{width:"16px",height:"16px",maxWidth:"16px",maxHeight:"16px",flexShrink:0}} fill="currentColor" viewBox="0 0 24 24">
